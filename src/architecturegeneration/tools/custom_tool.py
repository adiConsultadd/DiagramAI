        ...
        for line in lines:
            ...
            for section in section_names:
                for marker in markers:
                    if line_stripped == section or line_stripped == f"{marker}{section}" or line_stripped == f"{marker} {section}":
            ...
            for marker in markers:
                if line_stripped.startswith(marker) and current_section in section_names:
